...
class ShoppingCart(models.Model):
    ...
    def subtotal(self):
        amount = 0.0
        for item in self.shopping_cart_item:
...
class ShoppingCartItem(models.Model):
    shopping_cart = models.ForeignKey(ShoppingCart, related_name='items',related_query_name='item', on delete = models.CASCADE)
